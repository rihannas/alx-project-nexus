...
class OrderItem(models.Model):
    ...
    price = models.DecimalField(max_digits=10, decimal_places=2, default=0)  # price snapshot
    ...
    def total_price(self):
        # If quantity or price is None, return 0
    ...
    def save(self, *args, **kwargs):
        """Ensure price and quantity have proper values before saving"""
